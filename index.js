...
function processSum(numberList, callback) {
  const reduced = numberList.reduce(    (accum, cur) => accum + cur, 0  )
  return callback(reduced);
}
//console.log(processSum([1,2,3],cb))
